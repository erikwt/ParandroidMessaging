/**
 * @author Erik Wallentinsen & Jeffrey Klardie
 */
...
import org.parandroid.msg.transaction.MultipartDataMessage;
...
//    }
	...
	public static void sendPublicKey(Context context, String number) throws IOException{
		...
		String extraMessage = context.getString(R.string.parandroid_not_installed_msg);

...
public class BackwardsCompatibleAuthenticateActivity extends Activity implements OnClickListener {
    ...
    public void onClick(View v) {
		if(v.equals(submitButton)){
			...
			try{
				...
				// TODO: Remove this! In here now for backwards compatibility
				try{
					// If this fails, the password is really wrong.
					MessageEncryptionFactory.getPrivateKeyBackwardsCompatible(this);

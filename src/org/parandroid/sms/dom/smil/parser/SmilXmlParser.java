...
package org.parandroid.sms.dom.smil.parser;
...
public class SmilXmlParser {
    ...
    private void validateDocument(SMILDocument doc) {
         ...
         * @see org.parandroid.sms.dom.smil.SmilDocumentImpl#getBody()
         */
        doc.getBody();

        /*
         * Calling getLayout() will create "layout" element if it is not present.
         * @see org.parandroid.sms.dom.smil.SmilDocumentImpl#getLayout()
         */
        doc.getLayout();
    }
}

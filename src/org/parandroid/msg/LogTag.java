...
public class LogTag {
    public static final String TAG = "PMSG";

    public static final String TRANSACTION = "PMSG:transaction";
    public static final String APP = "PMSG:app";
    public static final String THREAD_CACHE = "PMSG:threadcache";

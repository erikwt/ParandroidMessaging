...
package org.parandroid.msg.dom.smil.parser;
...
import org.parandroid.msg.dom.smil.parser.SmilContentHandler;
...
public class SmilXmlParser {
    ...
    private void validateDocument(SMILDocument doc) {
         ...
         * @see org.parandroid.msg.dom.smil.SmilDocumentImpl#getBody()
         */
        doc.getBody();

        /*
         * Calling getLayout() will create "layout" element if it is not present.
         * @see org.parandroid.msg.dom.smil.SmilDocumentImpl#getLayout()
         */
        doc.getLayout();
    }
}

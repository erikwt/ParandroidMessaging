...
import static org.parandroid.msg.transaction.ProgressCallbackEntity.PROGRESS_ABORT;
import static org.parandroid.msg.transaction.ProgressCallbackEntity.PROGRESS_COMPLETE;
import static org.parandroid.msg.transaction.ProgressCallbackEntity.PROGRESS_START;
import static org.parandroid.msg.transaction.ProgressCallbackEntity.PROGRESS_STATUS_ACTION;
import static org.parandroid.msg.ui.MessageListAdapter.COLUMN_ID;
import static org.parandroid.msg.ui.MessageListAdapter.COLUMN_MMS_LOCKED;
import static org.parandroid.msg.ui.MessageListAdapter.COLUMN_MSG_TYPE;
import static org.parandroid.msg.ui.MessageListAdapter.PROJECTION;
...
import org.parandroid.msg.data.ContactList;
import org.parandroid.msg.data.Conversation;
import org.parandroid.msg.data.WorkingMessage;
import org.parandroid.msg.data.WorkingMessage.MessageStatusListener;
...
import org.parandroid.msg.model.SlideModel;
import org.parandroid.msg.model.SlideshowModel;
import org.parandroid.msg.transaction.MessagingNotification;
import org.parandroid.msg.ui.MessageUtils.ResizeImageResultCallback;
import org.parandroid.msg.ui.RecipientsEditor.RecipientContextMenuInfo;
import org.parandroid.msg.util.SendingProgressTokenManager;
...
public class ComposeMessageActivity extends Activity
    ...
    private void forwardMessage(MessageItem msgItem) {
        ...
        intent.setClassName(this, "org.parandroid.msg.ui.ForwardMessageActivity");
        startActivity(intent);
    }
